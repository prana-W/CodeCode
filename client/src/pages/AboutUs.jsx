import { Code2, Server, Terminal, Database, ShieldCheck, Zap, Bot, Trophy } from 'lucide-react';
            ...
            <div className="max-w-5xl mx-auto space-y-16">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        A high-performance, production-grade competitive programming platform inspired by Codeforces. Built from the ground up to handle massive concurrencies, code execution sandboxing, and real-time contest evaluations.
                    </p>
                ...
                {/* Features Section */}
                <div>
                    <h2 className="text-2xl font-bold mb-6 text-foreground border-b border-border pb-2">Platform Features</h2>
                ...
                {/* Tech Stack Section */}
                <div>
                    <h2 className="text-2xl font-bold mb-6 text-foreground border-b border-border pb-2">The Technology Stack</h2>
                        ...
                        <Card className="border-border shadow-sm">
                            <CardContent className="p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-xl font-bold">Backend System</h3>
                                </div>
                                <ul className="space-y-3">
                                    <TechItem name="Node.js & Express v5" desc="Non-blocking event-driven core architecture." />
                                    <TechItem name="MySQL 8" desc="Relational data integrity and complex multi-JOIN queries." />
                                    <TechItem name="Redis & BullMQ" desc="In-memory store and highly durable job queuing." />
                                    <TechItem name="Docker" desc="Isolated compilation and process-limited execution." />
                                    <TechItem name="Ollama" desc="Local LLM bridging for the AI assistant feature." />
                                    <TechItem name="Swagger UI" desc="Fully interactive API documentation served directly." />
                                </ul>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="border-border shadow-sm">
                            <CardContent className="p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-xl font-bold">Frontend System</h3>
                                </div>
                                <ul className="space-y-3">
                                    <TechItem name="React.js" desc="Component-driven dynamic user interfaces." />
                                    <TechItem name="Vite" desc="Blazing fast modern build tooling and HMR." />
                                    <TechItem name="Tailwind CSS" desc="Utility-first rapidly scalable styling system." />
                                    <TechItem name="Shadcn/ui" desc="Beautifully designed, accessible headless components." />
                                    <TechItem name="Lucide React" desc="Clean, consistent and sharp vector icon library." />
                                    <TechItem name="React Router" desc="Seamless client-side routing and protected boundaries." />
                                </ul>
                            </CardContent>
                        </Card>
                    </div>
