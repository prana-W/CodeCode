                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3.5 text-center">
                                                ...
                                                'completed' ? (
                                                    <span className="inline-flex items-center gap-1 text-[11px] text-emerald-500 font-semibold px-2.5 py-0.5 bg-emerald-500/10 rounded-full font-mono">
                                                        <CheckCircle2 className="w-3.5 h-3.5" />
                                                        Completed
                                                    </span>
                                                ) : c.contest_evaluation ===
                                                  'running' ? (
                                                    <span className="inline-flex items-center gap-1 text-[11px] text-blue-500 font-semibold px-2.5 py-0.5 bg-blue-500/10 rounded-full font-mono">
                                                        <RefreshCw className="w-3.5 h-3.5 animate-spin" />
                                                        Evaluating
                                                    </span>
                                                ) : (
                                                    <span className="inline-flex items-center gap-1 text-[11px] text-amber-500 font-semibold px-2.5 py-0.5 bg-amber-500/10 rounded-full font-mono">
                                            ...
                                            <td className="px-4 py-3.5 text-center">
                                                ...
                                                'pending' ? (
                                                    <Button
                                                        ...
                                                        className="gap-1.5 text-xs font-semibold uppercase tracking-wider px-4"
                                                    >
                                                  ...
                                                  'running' ? (
                                                    ...
                                                    <Button
                                                        ...
                                                        disabled
                                                        variant="ghost"
                                                        className="gap-1.5 text-xs font-semibold uppercase tracking-wider text-emerald-500 hover:text-emerald-500 hover:bg-transparent"
                                                    >
                                                        <CheckCircle2 className="w-3.5 h-3.5" />
                                                        Finalized
                                                    </Button>
