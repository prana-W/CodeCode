    ...
    return (
        <div className="hidden lg:flex lg:w-[42%] bg-primary text-primary-foreground flex-col justify-between p-12 relative overflow-hidden">
            ...
            <div className="relative flex items-center gap-2.5 z-10">
                ...
                <span className="text-xl font-bold tracking-tight">CodeCode</span>
            </div>
            ...
            <div className="relative z-10 space-y-7">
                ...
                <div className="rounded-xl bg-primary-foreground/10 border border-primary-foreground/20 p-5 font-mono text-sm space-y-1.5 leading-relaxed">
                    <p className="text-primary-foreground/40 text-xs mb-2">// your journey starts here</p>
                    <p>
                    ...
                    <p>
                        <span className="text-primary-foreground/55">while</span>(
                        <span className="text-primary-foreground font-semibold">true</span>) {'{'}
                    </p>
                    <p className="pl-5">
                        <span className="text-primary-foreground font-semibold">solve</span>(
                        <span className="text-primary-foreground/70">problem</span>
                        <span className="text-primary-foreground/55">++</span>);
                    </p>
                    <p className="pl-5">
                        <span className="text-primary-foreground">rating</span>{' '}
                        <span className="text-primary-foreground/55">+=</span>{' '}
                        <span className="text-primary-foreground/70">delta</span>;
                    </p>
                    <p>{'}'}</p>
                </div>
            </div>
            ...
            <div className="relative z-10 flex gap-10 pt-4 border-t border-primary-foreground/15">
                {[
                    ...
                    <div key={label}>
                        ...
                        <p className="text-primary-foreground/55 text-sm mt-0.5">{label}</p>
                    </div>
                ))}
            </div>
        </div>
